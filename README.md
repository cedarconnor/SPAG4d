...
A single-viewpoint panorama produces Gaussians with structural holes — behind foreground objects and at depth discontinuities the camera never observed. SPAG-4D fills these with novel views generated by OmniRoam. Two backends turn those views into Gaussians; both work on any PLY regardless of which generator produced it.
...
**Requirements:** OmniRoam generation runs in **WSL2** and needs ~48 GB VRAM (A6000 or better); SeedVR2 upscaling runs natively on Windows.
